...
export const FEATURE_DETAILS = [
  ...
  },
  {
    ...
    description:
      'Build custom experiences on the same engine that powers voice today — REST and streaming included. Chat and SMS will use it when they ship.',
  },
  {
    icon: 'badge',
...
export const OMNI_CHANNELS = [
  ...
  },
  {
    ...
    title: 'Chat',
    status: 'soon',
    description: 'Web and in-app chat on the same agent brain. Shipping next on the platform.',
  },
  {
    icon: 'sms',
    title: 'SMS',
    status: 'soon',
    description: 'Two-way text for confirmations, reminders, and missed-call recovery.',
  },
  {
    icon: 'code',
    title: 'API',
    status: 'live',
    description: 'REST and WebSocket APIs for custom experiences on the voice engine you run today.',
  },
];
...
export const HOME_FAQS = [
  ...
  {
    q: 'Do you offer chat and SMS, or only voice?',
    a: 'Voice agents are available now. Chat, SMS, and website voice are on the VoilitAI platform roadmap and will use the same builder, knowledge base, and tools as your phone agents when they ship.',
  },
  {
    q: 'How does VoilitAI work?',
    a: 'You design conversation flows in a visual builder (or via API), connect your knowledge base and tools, then deploy to phone numbers. Speech recognition, understanding, reasoning, and text-to-speech run in real time with sub-600ms replies. Chat and SMS will use those same flows when they ship.',
  },
  {
  ...
  },
  {
    ...
    a: 'The most reliable customer support answers every call and hands off to a human with a summary when judgment is needed. VoilitAI adds 99.99% uptime, simulation QA, and live knowledge-base answers so tier-1 never goes dark after hours. Chat and SMS will share that same context when those products ship.',
  },
];
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Voice agents are available now, including phone, SIP, and the API. Chat, SMS, and website voice are on the platform roadmap and will use the same agent brain, tools, and analytics when they ship.',
      },
    ],
  },
];
