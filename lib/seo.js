...
export const PAGE_META = {
  home: pageMetadata({
    title: 'Voice Agents & Conversation Platform | VoilitAI',
    description:
      'VoilitAI is the customer conversation platform. Start with production voice agents — a fast Vapi and Retell alternative for 24/7 support, booking, and CRM. Chat, SMS, and website voice are next.',
    path: '/',
    absoluteTitle: true,
    keywords: [
      ...KEYWORDS,
