...
export const TAGLINE = 'The platform for customer conversations. Voice first.';
...
export const DEFAULT_DESCRIPTION =
  'VoilitAI is the customer conversation platform. Start with production voice agents — a fast Vapi and Retell alternative for 24/7 support, booking, and CRM — then add chat, SMS, and website voice.';

export const FOOTER_DESCRIPTION =
  'The VoilitAI platform starts with human-sounding voice agents: answer 24/7, book appointments, update your CRM, and hand off with context. Chat, SMS, and website voice are next.';

export const DEFAULT_TITLE = 'Voice Agents & Conversation Platform | VoilitAI';
